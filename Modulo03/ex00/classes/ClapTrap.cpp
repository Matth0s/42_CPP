...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/15 02:16:03 by mmoreira          #+#    #+#             */
/*   Updated: 2022/02/15 02:16:04 by mmoreira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage( unsigned int amount )
{
	...
	else if (this->_hitPoints > amount)
	{
		...
		std::cout << "ClapTrap " << this->_name << " have taken " << amount << " of damage, getting " << this->_hitPoints << " of health!" << std::endl;
	}
	else
	{
		this->_hitPoints = 0;
		std::cout << "ClapTrap " << this->_name << " have taken " << amount << " of damage and died|" << std::endl;
	}
}
...
void	ClapTrap::beRepaired( unsigned int amount )
{
	...
	{
		this->_hitPoints += amount;
		std::cout << "ClapTrap " << this->_name << " healed " << amount << ", getting " << this->_hitPoints << " of health!" << std::endl;
		this->_energyPoints--;
	}
	else
		std::cout << "ClapTrap " << this->_name << " doesn't have energy points!" << std::endl;
